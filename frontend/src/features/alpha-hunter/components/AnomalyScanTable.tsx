...
export default function AnomalyScanTable({ onAddToWatchlist, onAddToInvestigation }: AnomalyScanTableProps) {
    ...
    const runScan = useCallback(async () => {
        ...
        setError(null);
        try {
            let url = `${API_BASE_URL}/api/alpha-hunter/stage1/scan?min_score=${minScore}&min_flow=0&max_price_change=20&max_results=20`;
    ...
    }, [minScore, strengthFilter, priceValue, priceOperator]);
