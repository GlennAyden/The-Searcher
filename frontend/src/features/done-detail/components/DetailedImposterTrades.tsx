...
import { ArrowUp, ArrowDown, Filter, X, TrendingUp, TrendingDown, Zap } from "lucide-react";
...
export const DetailedImposterTrades: React.FC<DetailedImposterTradesProps> = ({
    ...
    const displayedTrades = useMemo(() => {
        ...
        // Apply sorting
        filtered.sort((a, b) => {
            let aVal = a[sortConfig.key as keyof ImposterTrade];
            let bVal = b[sortConfig.key as keyof ImposterTrade];
