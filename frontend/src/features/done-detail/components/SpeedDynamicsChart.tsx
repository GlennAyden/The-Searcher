...
type SpeedDynamicsDataPoint = SpeedDynamicsChartProps['data'][number];

type SpeedDynamicsTooltipProps = {
    active?: boolean;
    payload?: Array<{ payload: SpeedDynamicsDataPoint }>;
    label?: string;
};

const CustomTooltip = ({ active, payload }: SpeedDynamicsTooltipProps) => {
